...
% set in LaTeX's Computer Modern font. 

% Option "headers" produces running heads. 

% Option "manuscript" formats
% the page in a way suitable for reading and commenting: 12 pt type,
...
% For black links, replace the above with:
